...
const config = {
  apiKey: firebaseSettings.REACT_APP_FIREBASE_KEY,
  authDomain: firebaseSettings.REACT_APP_AUTH_DOMAIN,
  databaseURL: firebaseSettings.REACT_APP_DATABASE_URL,
  projectId: firebaseSettings.REACT_APP_PROJECT_ID,
  storageBucket: firebaseSettings.REACT_APP_STORAGE_BUCKET,
  messagingSenderId: firebaseSettings.REACT_APP_MESSAGING_SENDER_ID
}
